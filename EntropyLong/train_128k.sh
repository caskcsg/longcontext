...
bsz=${BSZ:-64} # * 128k (seq len) / 2 (seq parallel size) = 4M
...
domains=(
    entropylong_dataset_128k@1.0
)

run_name="${suffix}_128k_baseline"
...
base_arguments=(
    ...
    # --torch_compile
    --cuda_empty_cache
    --config_overrides "rope_theta=200000000"
)
