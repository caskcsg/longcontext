...
from training.configuration_qwen2 import Qwen2Config
...
class Qwen2FlashAttention2(Qwen2Attention):
    ...
    def forward(
        ...
        attn_output = _flash_attention_forward(
            ...
            distributed_attn_func=distributed_attn_func
        )
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        if position_ids is None:
            ...
            position_ids = cache_position + position_ids[0]
        ...
        for decoder_layer in self.layers:
            ...
            if self.gradient_checkpointing and self.training:
                ...
                layer_outputs = decoder_layer(
                    ...
                    position_embeddings=position_embeddings,
                    seq_parallel_group=seq_parallel_group,
                    distributed_attn_func=self.distributed_attn_func,
                )
